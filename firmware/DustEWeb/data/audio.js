/* ==========================================================================
   DUST-E OS - the phone is the speaker.
...
(function () {
  ...
  function db() {
    ...
    dbp = new Promise(function (resolve) {
      try {
        var req = indexedDB.open('duste-audio', 1);
  ...
  A.onSound = function (m, via) {
    ...
    // The bin's own speaker has it. Playing it here as well is an echo.
    if (m.onBoard) { setNow('THE BIN SAYS: ' + why + ' (' + clip + ')'); return; }
  ...
  function bleInfo() {
    ...
    return h || { name: 'DUST-E', service: '7a5b0001-8e6f-4c1d-9b2a-3f4e5d6c7b8a',
