...
//
//  Network: joins the bin's own access point by default (DUST-E-SETUP), so
...
// Configuration
// ---------------------------------------------------------------------------
#define WIFI_SSID      "DUST-E-SETUP"      // the bin's AP (see DustEWeb settings.h)
#define WIFI_PASS      "dustebin"
...
static esp_err_t indexHandler(httpd_req_t* req) {
    static const char page[] =
        ...
        "<h3 style='color:#f5a623;letter-spacing:.2em'>DUST-E CAM</h3>"
