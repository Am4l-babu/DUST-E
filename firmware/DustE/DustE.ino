// =============================================================================
//  DUST-E  -  The Uncooperative Waste Management System
...
void setup() {
    ...
    Serial.println();
    Serial.println(F("=== DUST-E v0.0001 ==="));
...
void loop() {
    ...
    // fastest way to tell a hung loop from a hung mechanism during a live demo.
